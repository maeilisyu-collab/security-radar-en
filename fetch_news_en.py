...
Return format:
{{"keypoints":["point1","point2"],"analysis":[{{"title":"subtitle1","desc":"desc1"}},{{"title":"subtitle2","desc":"desc2"}},{{"title":"subtitle3","desc":"desc3"}}],"suggested_title":"rewritten title","bottom_line":"editor one-liner","action_today":"one action now"}}
...
- bottom_line: Editor's sharp take. Max 15 words. Must take a stance — no neutral summaries.
  No "users should be cautious" patterns. No passive voice. Make the reader feel it's personal.
  Good: "Your saved passwords may already be in someone else's hands."
  Good: "If you haven't patched yet, assume you're already compromised."
  Good: "This isn't a warning — it's already happening to people like you."
  Bad: "This incident highlights the importance of cybersecurity awareness." (neutral, useless)
  Bad: "Users are advised to take precautionary measures." (bureaucratic)
- action_today: One specific action right now. Max 15 words. Name the app/setting/path.
  "App → Setting → Action" format preferred. No vague advice.
  Good: "Chrome → Settings → Safety Check → Run now (2 min)"
  Good: "Windows → Settings → Windows Update → Check for updates"
  Good: "Enable 2FA on your email account right now — takes 3 minutes"
  Bad: "Update your security software to the latest version" (too vague)
  Bad: "Contact your IT department for assistance" (not actionable)
- All in English."""
...
def fetch_source(source: dict) -> list:
    ...
    for entry in feed.entries[:15]:
        ...
        articles.append({
            ...
            #   "bottom_line":     "editor's sharp take — no neutral summaries",
            #   "action_today":    "one action now (App → Setting → Action)"
            # }
        })
